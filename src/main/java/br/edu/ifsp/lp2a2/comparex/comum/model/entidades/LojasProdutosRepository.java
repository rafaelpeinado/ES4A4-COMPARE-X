...
public interface LojasProdutosRepository extends CrudRepository<LojaProduto, Integer>{
    @Query("select new br.edu.ifsp.lp2a2.comparex.comum.model.entidades.ResultadoQuantidadeLojas(lp.idProduto, count(lp.idLoja)) from LojaProduto lp group by lp.idProduto")
